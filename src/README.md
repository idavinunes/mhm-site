...
| `assets/apple-touch-icon.png` | 180×180 com o logo real sobre o preto — ícone de tela inicial no iOS. | ⚠️ |
...
com `build.py --check` no repo original da MMS, reproduzindo o `index.html` publicado **byte a byte**.
...
Se um dia a MHM mandar um símbolo quadrado do manual de marca, é só trocar os arquivos e
