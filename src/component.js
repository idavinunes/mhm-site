...
class Component extends DCLogic {
  ...
  renderVals() {
    ...
    const faqRaw = [
      ...
      ['Preciso pagar alguma coisa pela consultoria?', 'Não. A análise e a orientação da MHM são gratuitas. Você só assume o contrato se as condições forem boas para você.'],
      ...
      ['A MHM é confiável?', 'Sim. Somos correspondente bancário e trabalhamos apenas com instituições autorizadas pelo Banco Central. Você fala com uma pessoa de verdade do início ao fim.']
    ];
